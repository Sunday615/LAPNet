...
<template>
    ...
    <div class="conatinerproduct1-page1">
        <img id="bgproductpage1" src="../../../assets/Productassets/product3/bgtempleteproduct3-1.png" alt="">
    ...
    <div class="condition">
        ...
        <div class="titlecondition">
            ...
            <p style="font-family: notosanlao; font-size: 27px;">ລູກຄ້າທີ່ມີບັດ ATM ຂອງທະນາຄານທີ່ເປັນສະມາຊິກຂອງ LAPNet
                ສາມາດ<br>ໂອນເງິນຂ້າມທະນາຄານຜ່ານຕູ້ ATM ຂອງທະນາຄານສະມາຊິກ. <br> <span>
                    <p style="font-size: 27px; color:blue; font-family: notosanlao;">
    ...
    <div class="feeforservice">
        <img src="../../../assets/Productassets/product3/feeservice-bg.png" alt="">
    </div>
    <div class="tablefee">
