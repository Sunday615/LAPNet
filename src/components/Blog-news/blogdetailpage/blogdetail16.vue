        ...
        <div class="left-blog-container">
            ...
            <div class="descriptionline1">
                ...
                <p>    ເປັນກຽດລົງນາມເຊັນສັນຍາແຕ່ງຕັ້ງທີ່ປຶກສາທາງການເງິນຄັ້ງນີ້ໂດຍ:
                        ...
                        <li style="list-style:decimal; font-family: notosanlao; font-size: 19px;">    ທ່ານ ຫົງຄຳ ເພັດດາວົງ ຜູ້ອຳນວຍການ ບໍລິສັດ ລາວເນເຊີນນໍ ເພເມັ້ນ ເນັດເວີກ ຈຳກັດ</li>
                        <li style="list-style:decimal; font-family: notosanlao;font-size: 19px;">    ທ່ານ ອານຸກອນ ສຸທຳມະວົງ ຜູ້ອຳນວຍການ ບໍລິສັດ ຫຼັກຊັບລ້ານຊ້າງ ມະຫາຊົນ</li>
                </p>
                <p style="margin-top: 20px; font-size:19px">    ຈຸດປະສົງຂອງການລົງນາມເຊັນສັນຍາແຕ່ງຕັ້ງທີ່ປຶກສາທາງການເງິນໃນຄັ້ງນີ້ ແມ່ນເພື່ອ ປັບປຸງໂຄງສ້າງການດຳເນີນທຸລະກິດຂອງບໍລິສັດໃຫ້ເຂັ້ມແຂງ ໃນໄລຍະແຕ່ປີ 2021 ຫາ ປີ 2025.
                </p>
            ...
            <div class="imageinfo">
                <img style="object-fit: cover;" src="../../../../public/images/17/2.jpeg" alt="">
            </div>
            <div class="imageinfo">
