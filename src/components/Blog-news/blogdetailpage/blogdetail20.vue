...
<template>
    ...
    <div class="backbtn">
        <router-link to="/newsgridpage3"><button><i class="fa-solid fa-angle-left" style=""></i>
    ...
    <div class="container">
        <div class="left-blog-container">
            ...
            <div class="descriptionline1">
                ...
                <p style="margin-top: 20px; font-size:19px">    ຍ້ອນການໃຫ້ຄວາມຮ່ວມມືຂອງບັນດາສະມາຊິກສະພາບໍລິຫານ ທີ່ສະແດງອອກຜ່ານການປຶກສາຫາລື ແລະ ປະກອບຄຳຄິດຄຳເຫັນຮ່ວມກັນ ຕໍ່ຫຼາຍບັນຫາ ຢ່າງກົງໄປກົງມາ ເຮັດໃຫ້ເນື້ອໃນຂອງກອງປະຊຸມມີຄວາມສົມບູນຄົບຖ້ວນ ແລະ ສາມາດນຳໄປເປັນບ່ອນອີງໃນການຈັດຕັ້ງປະຕິບັດວຽກງານຕົວຈິງໃຫ້ເກີດໝາກຜົນດີທີ່ສຸດ. ດັ່ງນັ້ນ, ໃນວັນດຽວກັນ ກອງປະຊຸມສຳຄັນຂອງປີຈຶ່ງໄດ້ຮັບການສິ້ນສຸດລົງ ຢ່າງຈົບງາມ ແລະ ສຳເລັດຜົນ ຕາມຄາດໝາຍ.
                </p>
            ...
            <div class="imageinfo">
                <img style="object-fit: cover; object-position: center;" src="../../../../public/images/21/2.jpg" alt="">
            </div>
            <div class="imageinfo">
